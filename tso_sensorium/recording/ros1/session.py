"""Reusable episode recording sessions for ROS 1.
...
def build_recorder(
    recorder_config: RecorderConfig, output_folder: Path | str
) -> RosTopicRecorder:
    """Instantiate the ROS 1 recorder described by a config entry.
